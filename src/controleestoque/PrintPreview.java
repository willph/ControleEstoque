...
class PrintPreview extends JFrame implements ActionListener, ItemListener {
    ...
    JButton backButton = new JButton("Anterior"), forwardButton = new JButton("Proximo");
    ...
    public void itemStateChanged(ItemEvent ie) {
        ...
        backButton.setEnabled((combobox.getSelectedIndex() != 0));
        forwardButton.setEnabled((combobox.getSelectedIndex() != combobox.getItemCount() - 1));
        validate();
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (o == printButton) {
            try {
                ...
                JOptionPane.showMessageDialog(null, ex.toString(), "Erro ao impremir", 1);
            }
